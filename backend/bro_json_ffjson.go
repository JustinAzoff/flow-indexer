...
func (mj *BroIPFields) MarshalJSON() ([]byte, error) {
...
const (
	ffj_t_BroIPFieldsbase = iota
	ffj_t_BroIPFieldsno_such_key

	ffj_t_BroIPFields_ID_orig_h

	ffj_t_BroIPFields_ID_resp_h

	ffj_t_BroIPFields_Src

	ffj_t_BroIPFields_Dst
)

var ffj_key_BroIPFields_ID_orig_h = []byte("id.orig_h")

var ffj_key_BroIPFields_ID_resp_h = []byte("id.resp_h")

var ffj_key_BroIPFields_Src = []byte("src")

var ffj_key_BroIPFields_Dst = []byte("dst")

func (uj *BroIPFields) UnmarshalJSON(input []byte) error {
